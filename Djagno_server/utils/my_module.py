...
def liveness_detection():
    ...
    # 特征点检测器
    predictor = dlib.shape_predictor("C:\\Users\\28893\\Desktop\\graduate_face_recognition\\Djagno_server\\utils\\model\\shape_predictor_68_face_landmarks.dat")
    # 获取左眼的特征点
...
def vivo():
    liveness_detection()
    result = {"blink_total":blink_total,"mouth_total":mouth_total}
    return result
# video_path, src = sys.argv[1], sys.argv[2]
video_path = r'C:\\Users\\28893\\Desktop\\graduate_face_recognition\\Djagno_server\\vivoTest\\video\\.mp4'  # 输入的video文件夹位置
